...
function Marabu()
{
  ...
  this.window.size = {width:450,height:510};
  ...
  this.draw = function()
  {
    ...
    html += "      <h1>";
    html += "        <b><t id='osc1_wave_select'>ERROR</t></b>";
    html += "        <t id='osc1_xenv' class='box' style='display:none'>X</t>";
    html += "      </h1>";
    ...
    html += "    <div class='osc' style='width:180px; margin-bottom:15px'>";
    html += "      <h1>";
    html += "        <b><t id='osc2_wave_select'>ERROR</t></b>";
    html += "        <t id='osc2_xenv' class='box' style='display:none'>?</t>";
    html += "      </h1>";
    ...
    html += "      <h1>EFX";
    html += "        <t id='fx_filter_select'>ERROR</t>";
    html += "      </h1>";
